...
public class BankApp {
	private BufferedReader bReader = new BufferedReader(new InputStreamReader(
			System.in));
	...
	public static void main(String[] args) {
		...
		while (!command.equals("quit")) {
			...
			} catch (BadTransactionException | BadAccountException e) {
				System.err.println(e);
			}
		}
	}
	 ...
	 */
	private void doDeposit() throws IOException, BadTransactionException,
			BadAccountException {
		// Get account number.
	...
	/**
	 * doWithdraw() prompts the user for an account number and tries to perform
	 * a withdrawal transaction from that account.
	 *
	 * @exception IOException
	 *                if there are problems reading user input.
	 * @throws BadTransactionException
	 ...
	 *
	 * @param prompt
	 *            is the string printed to prompt the user.
	 */
	...
	/**
	 * readInt() returns an integer from the input stream after prompting the
	 * user.
	 *
	 * @param prompt
	 *            is the string printed to prompt the user.
